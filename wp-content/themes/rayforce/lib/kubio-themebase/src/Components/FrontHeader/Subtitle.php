		...
		return array(
			...
			'settings' => array(
				...
				"{$prefix}localProps.content" => array(
					'default' => __( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut feugiat aliquet convallis. Morbi cursus scelerisque est, a sodales mi fringilla sit amet. Donec ultrices id ante a tempus. Sed scelerisque.','rayforce' ),
					'control' => array(
