<?php
$rayforce_theme_svg_icons = array(
	'fort-awesome'         => array(
...
$rayforce_theme_divider_style = array(
...
$rayforce_title                         =  'Seize the moment &amp;<br>create your ultimate destiny.';
$rayforce_subtitle                      =  'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut feugiat aliquet convallis. Morbi cursus scelerisque est, a sodales mi fringilla sit amet. Donec ultrices id ante a tempus. Sed scelerisque.';
$rayforce_theme_action_button           = 'Get In Control';
$rayforce_theme_action_button_secondary =  'Contact Us';

$defaults = array(
	'default_icon'                      => $rayforce_theme_svg_icons['fort-awesome'],
	'icons'                             => $rayforce_theme_svg_icons,
	'divider_style'                     => $rayforce_theme_divider_style,
	'gradients'                         => $rayforce_gradients,

	'assets_js_key'                     => 'kubioFrontendData',

	'edit_this_text_in_customizer'      => $rayforce_title,
	'lorem_ipsum'                       => $rayforce_subtitle,
	...
	'front-header'                      => array(
		...
		'buttons'      => array(
			...
			'value' => array(
				array(
					'label'       => sprintf( $rayforce_theme_action_button, 1 ),
					'url'         => '#',
					'button_type' => '0',
					'index'       => 0,
				),
				array(
					'label'       => sprintf( $rayforce_theme_action_button_secondary, 1 ),
					'url'         => '#',
					'button_type' => '1',
					'index'       => 1,
				),
		...
		'title'        => array(
			'show'  => true,
			'value'      => $rayforce_title,
			'localProps' => array(
				'content' => $rayforce_title
			),
			'style' => array(
				'descendants' => array(
					'text' => array(
		...
		'subtitle'     => array(
			'show'  => true,
			'value'      => $rayforce_subtitle,
			'localProps' => array(
				'content' => $rayforce_subtitle
			),
			'style' => array(
				'descendants' => array(
					'text' => array(
						...
						'background' => array(
							...
							'overlay'   =>
								array(
									...
									'gradient'         => $rayforce_gradients['night_fade'],
		...
		'social_icons' => array(
			...
			'localProps' => array(
				'iconList' => array(
					array(
						'icon'       => $rayforce_theme_svg_icons['facebook-square-full'],
						'link_value' => '#',
						'index'      => 0,
					),
					array(
						'icon'       => $rayforce_theme_svg_icons['twitter-x'],
						'link_value' => '#',
						'index'      => 1,
					),
					array(
						'icon'       => $rayforce_theme_svg_icons['youtube'],
						'link_value' => '#',
						'index'      => 2,
					),
					array(
						'icon'       => $rayforce_theme_svg_icons['vimeo'],
						'link_value' => '#',
						'index'      => 3,
					),
				),
		...
		'icon_list'    => array(
			...
			'localProps' => array(
				'iconList' => array(
					array(
						'icon'       => $rayforce_theme_svg_icons['map-marker'],
						'text'       => '123, Main Street, City, Country',
						'link_value' => 'https://maps.google.com/',
						'index'      => 0,
					),
					array(
						'icon'       => $rayforce_theme_svg_icons['phone'],
						'text'       => '+1 234 567 890',
						'link_value' => 'tel:+1 234 567 890',
						'index'      => 0,
					),
					array(
						'icon'       => $rayforce_theme_svg_icons['envelope'],
	...
	'header'                            => array(
		...
		'social_icons' => array(
			...
			'localProps' => array(
				'icons' => array(
					...
					array(
						'icon'       => $rayforce_theme_svg_icons['whatsapp-square'],
						'link_value' => '#',
						'index'      => 1,
					),
					array(
		...
		'icon_list'    => array(
			...
			'localProps' => array(
				'iconList' => array(
					array(
						'icon'       => $rayforce_theme_svg_icons['map-pin'],
						'text'       => '1557 Frosty Lane, Binghamton, NY',
						'link_value' => '#',
						'index'      => 0,
					),
					array(
						'icon'       => $rayforce_theme_svg_icons['phone-square'],
