...
<div class="rayforce-notice-dont-show-container">
	<button class="button-link rayforce-dont-show-notice">
		<?php Translations::escHtmlE( 'dont_show_anymore' ); ?>
	</button>
</div>

<div class="rayforce-admin-notice-spacer">
	<div class="rayforce-admin-big-notice--container">
		<div class="content-holder">
			<div class="messages-area">
				<div class="title-holder">
					<h1><?php Translations::escHtmlE( 'would_you_like_to_install_front_page', rayforce_theme()->getName() ); ?></h1>
					<p><?php Translations::escHtmlE( 'theme_description', rayforce_theme()->getName() ); ?></p>
				</div>

				<ul>
					<li>
						<img src="<?php echo rayforce_theme()->getListMarkerUrl(); ?>" alt="">
			...
			<div class="front-page-preview">
				<img src="<?php echo esc_url( rayforce_theme()->getFrontPagePreview() ); ?>"/>
			</div>
		</div>
	</div>
</div>
