<?php get_header(); ?>
<main id="archive-cases" class="py-16 md:py-20">
	<div class="mx-auto max-w-7xl px-4">
		...
		<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
			...
			<article <?php post_class('rounded-xl border border-slate-200 p-6 shadow-sm'); ?>>
				...
				<a class="mt-4 inline-flex text-emerald-600 hover:text-emerald-700" href="<?php the_permalink(); ?>">Ver caso</a>
			</article>
			<?php endwhile; ?>
		</div>
		<div class="mt-8">
		...
		<?php else: ?>
		<p class="text-slate-600">No hay casos publicados todavía.</p>
		<?php endif; ?>
	</div>
</main>
<?php get_footer(); ?>
